...
export function StepHeader({
  ...
  const headerButton = (
    <button
      ...
      className={
        isExpanded
          ? "cursor-pointer flex w-full min-h-11 items-center gap-8 py-0 text-left transition-opacity hover:opacity-90 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand"
          : "cursor-pointer flex w-full min-h-11 items-center gap-8 border-b border-t border-accordion-border py-20 px-15 text-left transition-colors hover:bg-gray-200/60 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand "
      }
    >
