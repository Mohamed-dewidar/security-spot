...
export function ProductList({
  ...
  return (
    <ul className="flex flex-col gap-24 p-1 lg:grid lg:grid-cols-2 lg:gap-15 xl:flex xl:flex-row xl:items-stretch xl:gap-15 xl:overflow-x-auto">
      {products.map((product) => {
        ...
        return (
          <li
            key={product.id}
            className=" last:odd:lg:col-span-2 last:odd:lg:max-w-[360px] last:odd:lg:justify-self-center xl:col-span-auto  xl:justify-self-auto"
          >
            <ProductCard
              product={product}
              currency={currency}
